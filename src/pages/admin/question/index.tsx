...
const Question = () => {
<<<<<<< HEAD:src/pages/admin/question/Question.tsx
  const { data, isLoading } = useGetQuestionsQuery();
  const [searchTerm, setSearchTerm] = useState("");
=======
  const dispatch = useDispatch();
>>>>>>> 3cf0cf7797fcfdc7b74036988bf011c430c9104d:src/pages/admin/question/index.tsx
...
>>>>>>> 3cf0cf7797fcfdc7b74036988bf011c430c9104d:src/pages/admin/question/index.tsx
              <tr>
                ...
                <th
                  scope="col"
                  className="px-8 py-3 w-[40%] text-sm font-semibold"
                >
                  Title
                </th>
                <th
                  scope="col"
                  className=" py-3 w-[17%] text-sm font-semibold "
                >
                  Weightage
                </th>
                <th
                  scope="col"
                  className="px-[45px] py-3 w-[20%] text-sm font-semibold"
                >
                  Status
                </th>
